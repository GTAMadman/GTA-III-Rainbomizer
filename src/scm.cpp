...
void scm::InitialiseVehiclePatterns()
{
	...
	pattern = { .vehicle = {92}, .denied = { 93, 97, 98, 99, 103, 104, 106, 108, 112, 113, 117, 118, 122, 123, 126,
	...
	pattern = { .vehicle = {101}, .denied = {93, 97, 98, 99, 103, 104, 106, 108, 112, 113, 117, 118, 122, 123, 126,
	127, 130, 132, 133, 139, 144, 145, 146, 149}, .allowedType = {"car"}, .thread = {"kenji2"} };
	Patterns.push_back(pattern); // Denied all larger vehicles
	...
	pattern = { .vehicle = {105},.denied = {93, 97, 98, 99, 103, 104, 106, 108, 112, 113, 117, 118, 122, 123, 126,
	127, 130, 132, 133, 139, 144, 145, 146, 149}, .allowedType = {"car"}, .thread = {"kenji2"} };
	Patterns.push_back(pattern); // Denied all larger vehicles
